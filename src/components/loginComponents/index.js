...
const LoginComponents = () => {
    ...
    const HandleSubmit = async  () =>{
        let token = await axios.post('http://127.0.0.1:8000/login',{
            email:email,
            password:password
        })
                            ...
                            <input type="hidden" name="_csrf-ilovepdf" value="NhrYpLdeY-xocRKRjJFwZtt04rAvRcWP9Bs2LIqgozt0VKDl5jQN2ylCfMv_1zxSoxi251ksqPyOcUx87PjLeg=="/>
                                ...
                                <div className="form__group ">
                                    <div className="field-loginEmail required">
                                        <div className="input--icon input--email"><input type="text" id="loginEmail" className="input" name="LoginForm[email]" placeholder="Enter your email" autofocus="true" aria-required="true" onChange={(e)=> setEmail(e.target.value)}/></div><div className="help-block"></div>
                                    </div>    </div>
                                <div className="form__group ">
                                ...
                                <div className="forget-password">
                                    <p>
                                        <a href="https://www.ilovepdf.com/login/forgetpassword" id="forget-password">Forgot your password?</a>
                                    </p>
                                </div>
